...
module.exports = {
     ...
     */
     create:async(req,res,next) => {
        try {
            ...
            if(data){
                return commonResponse.success(res, "CLIENT_DETAILS_SAVE", 200, data, 'Success');
            }else{
    ...
    get:async(req,res,next) =>{
        try {
            ...
            if(data){
                return commonResponse.success(res, "CLIENT_GET", 200, data, 'Success');
            }else{
                return commonResponse.customResponse(res, "SERVER_ERROR", 400, {}, 'Something went wrong, Please try again');
            }
        } catch (error) {
     ...
     */
     update:async(req,res,next) => {
        try {
            ...
            if(update){
                return commonResponse.success(res, "CLIENT_DETAILS_GET", 200, update, 'Success');
            }else{
                return commonResponse.customResponse(res, "SERVER_ERROR", 400, {}, 'Something went wrong, Please try again');
            }
        } catch (error) {
    ...
    delete: async (req, res) => {
        try {
            ...
            if(data){
                return commonResponse.success(res, "CLIENT_DETAILS_DELETE", 200, data, 'Successfully deleted');
            }else{
