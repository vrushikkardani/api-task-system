...
//         try {
//             let counts = await userloginService.dashboardCounts();
//             if(counts){
...
//         try {
//             let getUser = await userloginService.get(req.params.id)
//             if(getUser){
//                     let deleteUser = await userloginService.delete(getUser._id);
//                     if(deleteUser){
